...
const result_3 = `
Краткая информация о выполненной работе:
- Не успел выполнить ни одного пункта по кастомному видеоплееру.
- Сделал доп. функционал (п.10)
- Все остальное выполнил.

12.10.2021 / 12.10.2021
Score: 124 (124/ 160)
1. Слайдер в секции Welcome (полностью выполнил) +24
2. Слайдер в секции Video (полностью выполнил) +20
3. Кастомный видеоплеер (не выполнил полностью) +0/36
4. Слайдер сравнения изображений в секции Explore (полностью выполнил) +10
5. Анимация при прокрутке изображений в секции Galery (полностью выполнил) +8
6. Калькулятор продажи билетов в секции Tiskets (полностью выполнил) +10
7. Калькулятор продажи билетов в форме продажи билетов (полностью выполнил) +14
8. Валидация формы (полностью выполнил) +16
9. Интерактивная карта в секции Contacts (полностью выполнил) +12
10. Любой собственный дополнительный функционал, улучшающий качество проекта (добавил кнопку "вверх" и изменение картинки по интервалу в секции buy-tickets) +10
`
